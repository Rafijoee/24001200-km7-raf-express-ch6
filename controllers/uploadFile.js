...
class UploadFile {
        ...
        try{
            ...
            const uploadPrisma = await prisma.gambar.create({
                data: {
                    ...
                    fileId: upload.fileId, // Simpan fileId di sini
                },
            });
            res.status(201).json({
    ...
    static async showFIleId(req, res) {
        const id = parseInt(req.params.id, 10); // Pastikan ini mengubah ke angka
        try {
    ...
    static async deleteFile(req, res) {
        ...
        try {
            ...
            // Hapus file dari ImageKit menggunakan fileId
